...
if theme.titlebar_style == 'windows' then
	...
	theme.titlebar_close_button_normal                   = titlebar_icon .. 'close.svg'
	...
	theme.titlebar_minimize_button_normal                = titlebar_icon .. 'minimize.svg'
	...
	theme.titlebar_maximized_button_normal_inactive      = titlebar_icon .. 'maximize.svg'
